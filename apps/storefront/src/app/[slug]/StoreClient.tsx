    ...
    <main className="pb-[calc(7rem+env(safe-area-inset-bottom))]">
      ...
      <footer className="mt-16 space-y-2 px-4 pb-6 text-center text-[11.5px] text-ink-mute">
        <p>
          loja online por{' '}
          <a
            href={`/?utm_source=loja&utm_medium=selo&utm_campaign=${encodeURIComponent(slug)}`}
            className="font-display font-semibold text-ink-soft underline decoration-line underline-offset-2 hover:text-brand-dark"
          >
            Menooo
          </a>
        </p>
